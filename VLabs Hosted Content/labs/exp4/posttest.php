...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
	 ...
	 &nbsp; &nbsp; Correct ans: A <br>Explanation : Perceptron learning rule comes under supervised learning. </span></p>
                        ...
                        <input type="radio" class="optradio2" name="optradio2" value="A"> A. True – this works always, and these multiple perceptrons learn to classify even complex problems.<br>
                        <input type="radio" class="optradio2" name="optradio2" value="B"> B. False – perceptrons are mathematically incapable of solving linearly inseparable functions, no matter what you do<br>
                        <input type="radio" class="optradio2" name="optradio2" value="C"> C. True – perceptrons can do this but are unable to learn to do it – they have to be explicitly hand-coded<br>
                        <input type="radio" class="optradio2" name="optradio2" value="D"> D. False – just having a single perceptron is enough<br>
	 ...
	 &nbsp; &nbsp; Correct ans: C <br>Explanation : because, Perceptron is linear classifier. </span></p>
                        ...
                        <br>
                        <input type="radio" class="optradio4" name="optradio4" value="B"> B.  <image src="images/option2.PNG" width="200px"/><br><br>
                        <input type="radio" class="optradio4" name="optradio4" value="C"> C. <image src="images/option3.PNG" width="200px"/><br><br>
                        <input type="radio" class="optradio4" name="optradio4" value="D"> D. <image src="images/option4.PNG" width="200px"/><br><br>
